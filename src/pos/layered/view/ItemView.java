...
public class ItemView extends javax.swing.JFrame {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lblTitle, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 663, Short.MAX_VALUE)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
    ...
    private void addItem(){
        ...
        ItemDto itemDto = new ItemDto(id,txtName.getText(),quantityOnHand,unitPrice);
    ...
    private void updateItem(){
        ...
        try {
            String updateItem = itemController.updateItem(itemDto);
    ...
    private void loadAllItems(){
        try {
            ...
            for(ItemDto itemDto:itemDtos){
                String[] rowData = {
                    Integer.toString(itemDto.getId()), itemDto.getName(), Integer.toString(itemDto.getQuantityOnHand()), Double.toString(itemDto.getUnitPrice())
                };
                dtm.addRow(rowData);
            }
        } catch (Exception ex) {
