...
public class OrderView extends javax.swing.JFrame {
    ...
    private void searchCustomer() {
        try {
            CustomerDto customer = customerController.getCustomer(Integer.valueOf(txtCustId.getText()));
            if (customer != null) {
    ...
    private void searchItem(){
         try {
            ItemDto item = itemController.getItem(Integer.valueOf(txtItemId.getText()));
            if(item !=null){
                tempItem = item;
    ...
    private void addToTable(){
        if(tempItem!=null){
            OrderDetailDto od = new OrderDetailDto(-1, tempItem.getId(), Integer.valueOf(txtQty.getText()), tempItem.getUnitPrice(), tempItem.getName());
    ...
    private void placeOrder(){
        OrderDto order = new OrderDto(Integer.valueOf(txtOid.getText()), tempCustomer.getId(), new Date(), total,orderDetailDtos );
        try {
